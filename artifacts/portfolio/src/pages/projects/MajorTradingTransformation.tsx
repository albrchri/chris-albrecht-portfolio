...
export default function MajorTradingTransformation() {
  useSeo({
    title: "Case Study: Major Trading Transformation | Christopher J. Albrecht",
    description: "A deep dive into the major trading platform transformation initiative led by Christopher J. Albrecht at UBS."
  });
    ...
    <PageTransition>
      <section className="container mx-auto px-6 md:px-12 py-20 md:py-36 max-w-4xl">
            ...
            <div className="grid md:grid-cols-4 gap-4 md:gap-8 items-start">
              ...
              <div className="md:col-span-3 bg-white/5 border border-white/10 p-10 rounded-sm">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Example: Led a cross-functional initiative to modernize UBS's core trading infrastructure across 12 global markets, delivering a consolidation of N legacy systems and achieving X% reduction in operational latency within 18 months.
                </p>
              </div>
            </div>
          </FadeIn>
            ...
            <div className="grid md:grid-cols-4 gap-4 md:gap-8 items-start">
              ...
              <div className="md:col-span-3 bg-white/5 border border-white/10 p-10 rounded-sm">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>[Describe the business challenge here. Who were the key stakeholders? How many teams / geographies were involved? What was the technical or organizational complexity?]</p>
                  <p>[Example: The initiative spanned N business units across X countries, requiring alignment between technology, compliance, and front-office trading teams with competing priorities and entrenched legacy workflows.]</p>
                </div>
              </div>
            </div>
          </FadeIn>
          ...
          <FadeIn delay={0.3}>
            <div className="grid md:grid-cols-4 gap-4 md:gap-8 items-start">
              ...
              <div className="md:col-span-3 bg-white/5 border border-white/10 p-10 rounded-sm">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>[Describe your methodology and approach. What frameworks did you apply? How did you structure the initiative? How did you manage risk, communication, and governance?]</p>
                  <p>[Example: Applied SAFe Agile Release Train structure, established bi-weekly steering committees, and implemented a real-time program dashboard that gave stakeholders full visibility into delivery milestones and risk posture.]</p>
                </div>
              </div>
            </div>
          </FadeIn>
            ...
            <div className="grid md:grid-cols-4 gap-4 md:gap-8 items-start">
              ...
              <div className="md:col-span-3 bg-white/5 border border-white/10 p-10 rounded-sm">
                ...
                <ul className="space-y-4">
                  {[
                    "[Result 1 — Replace with a specific, quantified outcome. E.g., Delivered N% improvement in trade processing speed.]",
                    "[Result 2 — Replace with a specific, quantified outcome. E.g., Reduced operational risk exposure by $XM through platform consolidation.]",
                    "[Result 3 — Replace with a leadership impact. E.g., Coached and upskilled a team of N engineers and PMs through the transition.]",
                    "[Result 4 — Replace with a strategic outcome. E.g., Initiative recognized by executive leadership as a model for future transformation programs.]"
                  ].map((item, i) => (
        ...
        <FadeIn delay={0.5} className="mt-36 pt-16 border-t border-white/10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
          ...
          <Link
            href="/projects/agile-culture-shift"
          ...
          >
            Next Case Study: Agile Culture Shift
            <ArrowRight size={14} />
          </Link>
        </FadeIn>
